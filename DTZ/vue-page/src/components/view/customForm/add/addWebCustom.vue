    ...
    <div class="web-tm-wrap">
        ...
        <div class="tm-bg">
            ...
            <ul class="viewFieldView">
                <div class="viewFieldView-title title-active">控件库</div>
            ...
            <div class="form-right">
                <div class="form-right-header">
                    <div :class="['form-right-header-title',rightActive===1?'active2':'']" @click=" rightActive=1">控件设置</div>
                    <div :class="['form-right-header-title',rightActive===2?'active2':'']" @click="rightActive=2">表单设置</div>
                </div>
                <!-- 表单属性 -->
                ...
                <div v-show="rightActive===1">
                    ...
                    <form v-show="checkObj.type=='m-input'">
                        ...
                        <div class="tm-form-item">
                            ...
                            <input style="width:253px;" type="number" class="tm-input" v-model="checkObj.minLength">
                        </div>
                        <div class="tm-form-item">
                            <div>
                            ...
                            <input style="width:253px;" type="number" class="tm-input" v-model="checkObj.maxlength">
                        </div>
                        ...
                        <div class="tm-form-item">
                            ...
                            <el-switch class="tm-switch" v-model="checkObj.required" active-text="" inactive-text="">
                            </el-switch>
                        </div>
                        <div class="tm-form-item">
                            <div>
                            ...
                            <el-switch class="tm-switch" v-model="checkObj.readonly" active-text="" inactive-text="">
                            </el-switch>
                        </div>
                        <div class="tm-form-item" v-show="checkObj.readonly">
                            <div>
                    ...
                    <form v-show="checkObj.type=='m-radio'">
                        ...
                        <div class="tm-form-item">
                            ...
                            <div v-for="(item,index) in checkObj.options" :key="index" class="tm-checked">
                                ...
                                <input maxlength="20" class="tm-input-select" v-model=item.value index/>
                    ...
                    <form v-show="checkObj.type=='m-upLoad'">
                        ...
                        <div class="tm-form-item">
                            ...
                            <input style="width:253px;" type="number" class="tm-input" v-model="checkObj.fileSize">
                        </div>
                    ...
                    <!-- m-signature -->
                    <form v-show="checkObj.type=='m-signature'">
                        <div class="tm-form-item">
                            <div>
                                <label class="tm-label">标题</label>
                                <span class="tm-label-span">最多10个字</span>
                        ...
                        <div class="tm-form-item" v-show='checkObj.required'>
                            <div>
                                <label class="tm-label">默认值</label>
                                <span class="tm-label-span"></span>
                            </div>
                ...
                <div class="form-main">
                    <div class="tm-formCanvas">
                        <div class="builderView">
                            <draggable style="height:516px;overflow-x: hidden; overflow-y: auto;" :list="myArray" @end='onEnd' :options="formDragOptions">
                                <div class="tm-filed-item" :index=index v-for="(element,index) in myArray" :key="index">
                                    ...
                                    <div class="tm-content" v-show="element.type=='m-signature'">
                                        <div class="js-remove" @click="nodeRemove(element,index)">X</div>
                                        <div class="handle">
                                            <span class="tm-label1">{{element.label}}</span>
                                            <div style="height:100px;" :class="['tm-input-road',element.readonly?'tm-readonly':'']">
                                                <!-- <base-icon style="margin-left:10px;" icon="count" /> -->
                                                <div class="handle-signature clearfix">
                                                    <div style="float:left">
                                                        <span class="tm-placeholder" style="margin-left:0px;" v-if="!element.readonly">{{element.placeholder}}</span>
                                                        <span class="tm-placeholder" v-else>{{element.value}}</span>
                                                        <span class="tm-required" v-show="element.required">(必填)</span>
                                                    </div>
                                                    <div style="float:right;margin-right:5px;color:#409eff">清除</div>
