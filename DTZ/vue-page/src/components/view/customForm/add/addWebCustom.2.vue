        ...
        <div class="tm-bg">
                            ...
                            <li class="filed-item" v-for="(element,index) in leftArray" :key="index">
                                <div class="handle">
                                    ...
                                    <span style="float:right">
                                        <base-icon style="font-size:18px;" :icon="element.icon" />
                                    </span>
                                </div>
                            </li>
                        </transition-group>
            ...
            <div class="tm-right">
                    ...
                    <div class="wf-form wf-formsettings" v-show="controEnable">
                        ...
                        <form v-if="checkObj.type=='m-input'">
                            ...
                            <div class="tm-form-item">
                                ...
                                <el-switch class="tm-switch" v-model="checkObj.isEnableRecord" on-text="" off-text="">
                                </el-switch>
                            </div>
                            <div class="tm-form-item">
                                <div>
                                ...
                                <el-switch class="tm-switch" v-model="checkObj.required" on-text="" off-text="">
                                </el-switch>
                            </div>
                            <div class="tm-form-item">
                                <div>
                                ...
                                <el-switch class="tm-switch" v-model="checkObj.readonly" on-text="" off-text="">
                                </el-switch>
                            </div>
                            <div class="tm-form-item" v-show="checkObj.readonly">
                                <div>
                        ...
                        <form v-if="checkObj.type=='m-address'">
                            ...
                            <div class="tm-form-item">
                                ...
                                <el-switch class="tm-switch" v-model="checkObj.hideDistrict" on-text="" off-text="">
                                </el-switch>
                            </div>
                            <div class="tm-form-item">
                                <div>
              ...
              <div class="tm-form-item">
                ...
                <el-switch class="tm-switch" v-model="checkObj.startDateIsToday" on-text="" off-text="">
                </el-switch>
              </div>
              <div class="tm-form-item">
                <div>
                ...
                <el-switch class="tm-switch" v-model="checkObj.endDateIsToday" on-text="" off-text="">
                </el-switch>
              </div> -->
                            <div class="tm-form-item">
                                <div>
                  ...
                  <span class="tm-label-span">最多n项</span>
                        ...
                        <form v-if="checkObj.type=='m-checkbox'">
                            ...
                            <div class="tm-form-item">
                                ...
                                <div v-for="(item,index) in checkObj.options" class="tm-checked">
                                    <input maxlength="20" class="tm-input-select" :value=item.value index/>
                                    <span v-if="checkObj.options.length > 1" style="width:15px;height: 15px;background-color: #333333;border-radius: 50%" @click="deleteSelector(index)">
                                        <i class="el-icon-minus" style="color: #f4f4f4"></i>
                                    </span>
                                    <span style="width:15px;height: 15px;background-color: #333333;border-radius: 50%;margin-left: 5px" @click="addSelector(index)">
                                        <i class="el-icon-plus" style="color: #f4f4f4"></i>
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="tm-form-item">
                                <div>
                                    <label class="tm-label">是否必选</label>
                                    <span class="tm-label-span"></span>
                                </div>
                                <el-switch class="tm-switch" v-model="checkObj.required" on-text="" off-text="">
                                </el-switch>
                        ...
                        <form v-if="checkObj.type=='m-scan'">
                            ...
                            <div class="tm-form-item">
                                ...
                                <el-switch class="tm-switch" v-model="checkObj.required"></el-switch>
                            </div>
                            <div class="tm-form-item">
                                <div>
                                    <label class="tm-label">操作角色</label>
                        ...
                        <!-- m-person-->
                        <form v-if="checkObj.type=='m-person'">
                            <div class="tm-form-item">
                                <div>
                                    <label class="tm-label">标题</label>
                                    <span class="tm-label-span">最多10个字</span>
                  ...
                  <span style="width:15px;height: 15px;background-color: #333333;border-radius: 50%;margin-left: 5px" @click="addSelector(index)">
                    <i class="el-icon-plus"></i>
                            ...
                            <div class="tm-form-item">
                                ...
                                <el-switch class="tm-switch" v-model="checkObj.disDelAble" on-text="" off-text="">
                                </el-switch>
                            </div>
                            <div class="tm-form-item">
                                <div>
                        ...
                        <form v-if="checkObj.type=='m-gps-point'">
                            ...
                            <div class="tm-form-item">
                                ...
                                <el-switch class="tm-switch" v-model="checkObj.isAutoGetGPS" on-text="" off-text="">
                                </el-switch>
                            </div>
                            <div class="tm-form-item">
                                <div>
                            ...
                            <div class="tm-form-item">
                                ...
                                <div class="wf-field wf-setting-icon">
                                    <div class="fieldblock">
                                       ...
                                       is-checked" style="top:-23px;left:26px">
            ...
            <div class="form" style=" overflow: hidden;">
                <div class="tm-formCanvas">
                    <div class="builderView">
                        <draggable style="min-height:400px;" :list="myArray" @add='onAdd' @end='onEnd' :options="formDragOptions">
          ...
          <div class="handle">
            ...
            <div style="float: right;margin-right: 10px">
              ...
              <span class="tm-required" v-show="element.required">(必填)</span>
                                ...
                                <!-- m-person -->
                                <div class="tm-content" v-show="element.type=='m-person'" :class="{'tm-readonly':element.readonly}">
                                    <div class="js-remove" @click="nodeRemove(element,index)">X</div>
                                    <div class="handle">
                                        <span class="tm-label1">{{element.label}}</span>
                                        <span class="tm-float-right">
    ...
    async formSave() {
      ...
      if (vm.myArray.length === 0) {
        ...
        if (vm.$route.query && vm.$route.query.form_items) {
          ...
          Object.assign(custom, Array, vm.formInfo); //对象合并
        ...
        // vm.$http
        //   .post("/system/template/addsystemplate", custom)
        //   .then(function(res) {
        //     //保存表单接口
        //     //成功与否判断
        //     if (!res.data.success) {
