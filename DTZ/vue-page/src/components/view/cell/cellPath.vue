<template>
  <div class="cell">
    ...
    <base-map :height="screenHeight" :center="center"  @ready="ready" :zoom="19"></base-map>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    ready({ BMap, map }) {
      ...
      //   style: "grayscale"
      // });
      console.log('goadu',this.screenHeight);
      this.map = map;
      this.setMapTool();
      this.getAreaData();
    },
    ...
    setMapTool() {
      ...
      drawingManager.addEventListener("overlaycomplete", function(e) {
        ...
        _self.mapCellDInfo.BGSQua = BMapLib.GeoUtils.getPolygonArea(
          e.overlay
        ).toFixed(2);
    ...
    addPolygon(data) {
      ...
      if (arr != null) {
        ...
        this.mapCellDInfo.BGSQua = BMapLib.GeoUtils.getPolygonArea(
          polygonLayer
        ).toFixed(2);
