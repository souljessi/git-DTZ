<template>
  <div class="basemarquee" :style="{height: height + 'px'}">
    <ul class="basemarquee-box" ref="box" :style="{transform: `translate3d(0,${currenTranslateY}px,0)`, transition: `transform ${noAnimate ? 0 : duration}ms`}">
      <slot></slot>
    </ul>
  </div>
</template>
